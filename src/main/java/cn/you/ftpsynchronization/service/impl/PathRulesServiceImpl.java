package cn.you.ftpsynchronization.service.impl;
...
public class PathRulesServiceImpl implements PathRulesService {
    ...
    public void updatePath(FileInfo fileInfo) {
        if (fileInfo.getId()==null||fileInfo.getId().isBlank()) throw new IllegalArgumentException(I18n.text("validation.ruleIdRequired"));
